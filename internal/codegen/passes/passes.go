// Package passes Creates analysers for go/analysis
...
func GetAnalysers() []*analysis.Analyzer{
    analyzers := make([]*analysis.Analyzer, 0)
        ...
        analyzers = append(analyzers, appends.Analyzer)
        ...
        analyzers = append(analyzers, defers.Analyzer)
    
        analyzers = append(analyzers, directive.Analyzer)
        ...
        analyzers = append(analyzers, httpmux.Analyzer)
        ...
        analyzers = append(analyzers, usesgenerics.Analyzer)
